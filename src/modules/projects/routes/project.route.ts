...
import { createProject, getAllProjects, getProjectById, updateProject, deleteProject, getMembers} from "../controllers/project.controller";
...
projectRouter.get('/:id/members',authenticateToken,checkBlacklist,  getMembers);
...
projectRouter.put("/:id", authenticateToken, checkBlacklist, validateRequest({ body: updateProjectSchema }), updateProject);
