 ...
 taskPriority: Joi.number()
  ...
  taskEndDate: Joi.string()
    ...
    .messages({
     ...
     taskStatusId: Joi.string()
    .uuid()
    .required()
    .messages({
      'string.base': 'El estado de tarea debe ser una cadena.',
      'string.guid': 'El estado de tarea debe ser un UUID válido.',
      'any.required': 'El estado de tarea es obligatorio.'
    })
});
